...
class TestSSLParameterPropagation(unittest.TestCase):
    ...
    def test_ssl_parameter_deep_copy_in_robust_connection(self):
        ...
        with patch("manman.repository.rabbitmq.connection.Connection") as mock_connection_class:
            ...
            self.assertEqual(
                stored_params["ssl_options"]["server_hostname"], 
                "test.example.com"
            )
    ...
    def test_deep_copy_connection_params_method(self):
        ...
        with patch("manman.repository.rabbitmq.connection.Connection") as mock_connection_class:
            ...
            self.assertIsNot(copied_params["ssl_options"], connection_params["ssl_options"])
            self.assertEqual(
            ...
            self.assertIsNot(copied_params["other_param"], connection_params["other_param"])
            self.assertEqual(
