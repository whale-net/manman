...
class RobustConnection:
    ...
    def _connect(self) -> bool:
        ...
        try:
            with self._lock:
                ...
                logger.info("Establishing RabbitMQ connection with heartbeat=%s", 
    ...
    def _reconnect_loop(self):
        ...
        while attempt < self._max_reconnect_attempts and not self._should_stop:
            attempt += 1
            logger.info("Reconnection attempt %d/%d", attempt, self._max_reconnect_attempts)
                ...
                if self._connect():
                    ...
                    if self._on_connection_restored:
                        try:
                            ...
                            logger.exception("Error in connection restored callback: %s", e)
    ...
    def get_connection(self) -> Connection:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.exception("Unexpected error during connection health check: %s", e)
                self._start_reconnect_thread()
